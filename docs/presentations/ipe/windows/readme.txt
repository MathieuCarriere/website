...
This is a binary distribution for Windows XP or higher (zoom and pan
gestures will only work on Windows 7 or higher).
...
I test with both the MikTeX distribution ("http://www.miktex.org") and
with Texlive for Windows (http://tug.org/texlive/windows.html).  Make
