...
\begin{document}
\coursetitle{Directed and Undirected Graphical Models}
\semester{2013/2014}
...
\begin{proposition}
Let $G = (V, E)$ and $G' = (V, E')$ be two undirected graphs.\\
\begin{equation*}
...
\begin{equation*}
p(x) =  \displaystyle \frac{1}{Z} \prod_{C \in \mathcal{C} \atop C \subset A \cup S} \psi_C(x_C) \prod_{C \in \mathcal{D}'} \psi_C(x_C) = f(x_{A \cup S}) g(x_{B \cup S})
\end{equation*}
