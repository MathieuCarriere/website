...
\begin{document}
	...
	%\section{Submitted articles}
		...
		\cventry{-}{\normalfont Structure and Stability of the 1-Dimensional Mapper. M. Carri\`ere, S. Oudot}
                ...
                \cventry{-}{\normalfont On the Metric Distortion of Embedding Persistence Diagrams into Reproducing Kernel Hilbert Spaces. M. Carri\`ere, U. Bauer}
                          {\textit Preprint}
	...
	\section{Coding projects}
		\cventry{-}{\normalfont Cover complex module of the C++ GUDHI library}{}{}{}{}
		\cventry{-}{\normalfont sklearn-tda: a scikit-learn compatible Python library implementing various vectorization and kernel methods used in TDA}{}{}{}{}
