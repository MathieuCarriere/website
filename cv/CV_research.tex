...
\begin{document}
	...
	\section{Research Articles}
		...
		\cventry{-}{\normalfont Two-Tiers Mapper: a user-friendly clustering method for global gene expression based on topology. R. Jeitziner, 
                          ...
                          {\textit{Accepted for publication in Bioinformatics, 2019}}
	...
	%\section{Submitted articles}
		...
		\cventry{-}{\normalfont Local Equivalence and Intrinsic Metrics between Reeb graphs. M. Carri\`ere, S. Oudot}
                ...
                \cventry{-}{\normalfont On the Metric Distortion of Embedding Persistence Diagrams into separable Hilbert spaces. M. Carri\`ere, U. Bauer}
                          {\textit Accepted for publication in the Proceedings of the Symposium on Computational Geometry, 2019}
