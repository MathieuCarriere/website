...
\begin{document}
	...
	\subsection{Machine Learning}
		...
		\cventry{-}{\normalfont A General Neural Network Architecture for Persistence Diagrams and Graph Classification. M. Carri\`ere, 
                           F. Chazal, Y. Ike, T. Lacombe, M. Royer, Y. Umeda}
                          {\textit{Preprint, 2019}}
                          {}{}{\small Defined general Neural Net architecture for Persistence Diagrams with application in graph classification.}
	...
	\subsection{Statistical Analysis}
		...
		\cventry{-}{\normalfont Two-Tier Mapper: a user-friendly clustering method for global gene expression based on topology. R. Jeitziner, 
                           M. Carri\`ere, J. Rougemont, S. Oudot, K. Hess, C. Brisken}
                          {\textit{Bioinformatics, 2019}}
		...
		\cventry{-}{\normalfont Topological Data Analysis of single-cell Hi-C contact maps. M. Carri\`ere, 
                           R. Rabadan}
                          {\textit{Proceedings of the Abel Symposium, 2019}}
	...
	%\section{Submitted articles}
		...
		\cventry{-}{\normalfont Local Equivalence and Intrinsic Metrics between Reeb graphs. M. Carri\`ere, S. Oudot}
                          { \textit{Proceedings of the Symposium on Computational Geometry}, 2017}
                ...
                \cventry{-}{\normalfont On the Metric Distortion of Embedding Persistence Diagrams into separable Hilbert spaces. M. Carri\`ere, U. Bauer}
                          {\textit Proceedings of the Symposium on Computational Geometry, 2019}
